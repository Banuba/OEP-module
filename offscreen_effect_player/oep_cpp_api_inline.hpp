...
#if !defined(INCLUDE_OEP_CPP_API_INLINE_MACRO)
    #error "Do not include this file. Use 'oep_api.hpp' to include the API dependent file."
#endif /* !defined(INCLUDE_OEP_CPP_API_INLINE_MACRO) */
...
namespace bnb::api
{
    ...
    {
        m_ep = std::move(bnb::interfaces::effect_player::create({width, height, bnb::interfaces::nn_mode::automatically, bnb::interfaces::face_search_mode::good, false, manual_audio}));
    }
